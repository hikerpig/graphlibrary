// copy from @types/graphlib
declare module '@pintora/graphlib' {
  ...
  export class Graph<NodeData=any, EdgeData=any, GraphData=any> {
     ...
     */
    setDefaultNodeLabel(label: Partial<NodeData>): this
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setNode(name: string, label?: NodeData): this
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setNodes(names: string[], label?: NodeData[]): this
